...
(function (global, factory) {
  ...
  function Spicr( element, options ) {
    ...
    var self = this, tws = self.tweens = [], vars = {},
      ...
      swipeEvents = supportTouch && isMobile ? touchEvents : mouseSwipeEvents,
    ...
    function toggleEvents(action){
      ...
      touchOption && slides.length > 1 && element[action]( swipeEvents.start, touchDownHandler, passiveHandler );
      if (pageNav) { pageNav[action]("click", pageHandler); }
    }
    function touchDownHandler(e) {
      if ( vars.isTouch ) { return; }
      vars.startX = e.changedTouches ? e.changedTouches[0].pageX : e.pageX;
  ...
  var supportTransform = transformProperty in document.body.style;

  function onStartLegacyTransform(tweenProp){
  ...
  var BaseLegacyTransform = {
    ...
    Util: {transformProperty: transformProperty}
  };
  ...
  var K = {
    ...
    Components: {
      Transform : new AnimationBase(BaseLegacyTransform),
  ...
  var transformOriginLegacy = trueProperty('transform-origin');

  function carouselLegacy(elem,items,active,next,direction) {
    var carouselTweens = [],
    ...
    if ( translate ) {
      var initialTranslate = support3DTransform ? [0,0,0] : [0,0],
    ...
    if ( rotate ) {
      var initialRotate = support3DTransform ? [0,0,0] : 0,
  ...
  function layerLegacy(elem,isInAnimation,nextData) {
